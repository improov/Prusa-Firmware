...
// Printer revision
#define PRINTER_TYPE PRINTER_BEARMERA
#define PRINTER_NAME PRINTER_BEARMERA_NAME
...
// Printer name
#define CUSTOM_MENDEL_NAME "BEAR HEMERA"
...
#define TMC2130_CURRENTS_R {26, 30, 45, 63}  // default running currents for all axes
#define TMC2130_CURRENTS_R_HOME {13, 15, 25, 63}  // homing running currents for all axes
